...
export const projects = [
  ...
  { name: "Session Extractor", description: "Browser extension for transparent session management and data portability.", href: "https://github.com/uncensoredcode/session_extractor" }
];
